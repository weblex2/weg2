...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    ...
                    <button onclick="importFromImap()" id="imap-btn"
                ...
                <div class="mt-6 border-t pt-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <button onclick="importByDateRange()" id="date-btn"
        ...
        <!-- Debug Output -->
        <div id="debug-output"
            class="hidden bg-gray-900 text-green-400 rounded-lg p-4 mb-8 font-mono text-xs overflow-x-auto"></div>
    ...
    <script>
        ...
        async function uploadFiles() {
            ...
            debug('Starte Upload von ' + selectedFiles.length + ' Datei(en)...');
            ...
            try {
                ...
                try {
                    ...
                    throw new Error('Server gab kein JSON zurück. Siehe Debug-Output für Details.');
                }
        ...
        async function importFromImap() {
            ...
            debug('Starte IMAP Import - Ordner: ' + folder + ', Limit: ' + (limit || 'alle'));
            ...
            try {
                ...
                btn.disabled = false;
                btn.textContent = 'E-Mails importieren';
            }
        }
        ...
        async function importByDateRange() {
            ...
            debug('Datumsbereich Import - Von: ' + dateFrom + ', Bis: ' + dateTo);

            if (!dateFrom || !dateTo) {
                showMessage('Bitte beide Daten auswählen', 'error');
                debug('Fehler: Datum(e) fehlen');
                return;
            }
            ...
            try {
                ...
                btn.disabled = false;
                btn.textContent = 'Import nach Datum';
            }
        }
        ...
        // Zeige Debug-Info beim Laden
        debug('Seite geladen - CSRF Token: ' + csrfToken.substring(0, 10) + '...');
        debug(
            'Routes: IMAP={{ route('emails.import.imap') }}, DateRange={{ route('emails.import.daterange') }}, Upload={{ route('emails.import.upload') }}'
        );
    </script>
</body>
